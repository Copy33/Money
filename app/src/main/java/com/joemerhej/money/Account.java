...
public class Account
{
    ...
    public void mock()
    {
        ...
        try
        {
            ...
            applyTransaction(new Transaction(TransactionType.DEPOSIT, new BigDecimal(19176), Currency.AED, sdf.parse("29/10/2017 15:03:20"), null, null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(19176), Currency.AED, sdf.parse("29/10/2017 15:02:55"), null, null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(18400), Currency.AED, sdf.parse("29/10/2017 15:01:23"), null, null));
            applyTransaction(new Transaction(TransactionType.DEPOSIT, new BigDecimal(30000), Currency.AED, sdf.parse("29/10/2017 14:54:45"), null, null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(28.00), Currency.AED, sdf.parse("29/10/2017 10:44:21"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(30.00), Currency.AED, sdf.parse("29/10/2017 10:00:52"), "www.turnlunchon.com, INTERNET. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(18.00), Currency.AED, sdf.parse("28/10/2017 21:38:03"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(396.30), Currency.AED, sdf.parse("28/10/2017 21:27:03"), "CARREFOUR BR OF -472603, DUBAI. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(22.00), Currency.AED, sdf.parse("28/10/2017 20:29:23"), "CAREEM NETWORKS FZ LLC", null));
            ...
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(65.00), Currency.AED, sdf.parse("28/10/2017 02:31:02"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(29.00), Currency.AED, sdf.parse("27/10/2017 16:23:02"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(40.00), Currency.AED, sdf.parse("27/10/2017 15:01:04"), "LE MERIDIEN MINA SEYAHI, DUBAI. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(75.00), Currency.AED, sdf.parse("27/10/2017 14:58:52"), "LE MERIDIEN MINA SEYAHI, DUBAI. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(49.00), Currency.AED, sdf.parse("27/10/2017 13:18:03"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(29.00), Currency.AED, sdf.parse("27/10/2017 01:44:42"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(33.00), Currency.AED, sdf.parse("26/10/2017 21:16:04"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(30.00), Currency.AED, sdf.parse("26/10/2017 16:39:33"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(31.00), Currency.AED, sdf.parse("26/10/2017 13:36:06"), "BAKEMART PLUS   -739803, DUBAI. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(29.00), Currency.AED, sdf.parse("26/10/2017 10:44:12"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(34.00), Currency.AED, sdf.parse("25/10/2017 20:47:14"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.DEPOSIT, new BigDecimal(2202), Currency.AED, sdf.parse("25/10/2017 20:45:42"), null, null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(27.00), Currency.AED, sdf.parse("25/10/2017 17:59:53"), "CAREEM NETWORKS FZ LLC", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(34.00), Currency.AED, sdf.parse("25/10/2017 14:36:14"), "ZOMATO ORDER, DUBAI. Avl Cr.", null));
            applyTransaction(new Transaction(TransactionType.WITHDRAWAL, new BigDecimal(27.00), Currency.AED, sdf.parse("25/10/2017 10:36:42"), "CAREEM NETWORKS FZ LLC", null));
        }
